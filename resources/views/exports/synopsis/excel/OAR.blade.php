...
<table style="font-size:8px;">
    ...
    <tr>
      <td colspan="4" style="text-align: center;">
        TABLE XVIII. OVERALL RECOVERIES
      </td>
    </tr>
    ...
    <thead>
        ...
        <tr>
            ...
            <th style="font-size:10px; width:25px; text-align:center;">STANDARD <br>BOILING HOUSE <br>RECOVERY</th>
    ...
    <tbody>
            ...
            @foreach ($collection as $key => $data)
                @if($data->mill->report_region == $reg_key)
                    ...
                    <tr>
                        ...
                        <td style="font-size:10px; text-align:right;"> {{ displayData($data->reduced_oar) }}</td>
                    </tr>
                @endif
            @endforeach
        @endforeach
        ...
        <tr>
            ...
            <td style="font-size:10px; font-weight:bold; text-align:right;">{{ displayData($total_reduced_oar) }}</td>
        </tr>
    </tbody>
</table>