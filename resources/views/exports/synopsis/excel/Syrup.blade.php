...
<table style="font-size:8px;">
    ...
    <thead>
        ...
        <tr>
            ...
            <th style="font-size:10px; width:15px; text-align:center;">INC. IN AP <br>MJ TO SYRUP</th>
        </tr> 
    </thead>
    <tbody>
            ...
            @foreach ($collection as $key => $data)
                @if($data->mill->report_region == $reg_key)
                    ...
                    <tr>
                        ...
                        <td style="font-size:10px; text-align:right;"> {{ displayData($data->ph) }}</td>
                        <td style="font-size:10px; text-align:right;"> {{ displayData($data->inc_in_ap) }}</td>
                    </tr>
                @endif
            @endforeach
        @endforeach
        ...
        <tr>
            ...
            <td style="font-size:10px; font-weight:bold; text-align:right;">{{ displayData($total_ph) }}</td>
            <td style="font-size:10px; font-weight:bold; text-align:right;">{{ displayData($total_inc_in_ap) }}</td>
        </tr>
    </tbody>
</table>