...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_POTENTIAL_REVENUE_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/potential_revenue/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/potential_revenue/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('POTENTIAL_REVENUE_UPDATE_LIST', {});
