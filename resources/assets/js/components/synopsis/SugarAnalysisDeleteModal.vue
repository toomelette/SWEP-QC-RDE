...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_SUGAR_ANALYSIS_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/sugar_analysis/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/sugar_analysis/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('SUGAR_ANALYSIS_UPDATE_LIST', {});
