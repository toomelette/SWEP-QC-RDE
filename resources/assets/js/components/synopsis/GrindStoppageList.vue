...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            EventBus.$on('GRIND_STOPPAGE_UPDATE_LIST', (data) => {
        ...
        methods: {
            ...
            fetch(page_no){ 
               ...
               axios.get('synopsis/grind_stoppage', { params: { q: this.search_value, e: this.entry_value, page: page_no, } })
                    .then((response) => {
            ...
            emitCreateModal(){ 
                EventBus.$emit('OPEN_GRIND_STOPPAGE_CREATE_MODAL', {});
            },

            emitUpdateModal(update_key){ 
                EventBus.$emit('OPEN_GRIND_STOPPAGE_UPDATE_MODAL', {'update_key': update_key});
            },

            emitDeleteModal(delete_key){  
                EventBus.$emit('OPEN_GRIND_STOPPAGE_DELETE_MODAL', {'delete_key': delete_key});
            },
