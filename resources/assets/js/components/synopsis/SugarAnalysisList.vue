...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            EventBus.$on('SUGAR_ANALYSIS_UPDATE_LIST', (data) => {
        ...
        methods: {
            ...
            fetch(page_no){ 
               ...
               axios.get('synopsis/sugar_analysis', { params: { q: this.search_value, e: this.entry_value, page: page_no, } })
                    .then((response) => {
            ...
            emitCreateModal(){ 
                EventBus.$emit('OPEN_SUGAR_ANALYSIS_CREATE_MODAL', {});
            },

            emitUpdateModal(update_key){ 
                EventBus.$emit('OPEN_SUGAR_ANALYSIS_UPDATE_MODAL', {'update_key': update_key});
            },

            emitDeleteModal(delete_key){  
                EventBus.$emit('OPEN_SUGAR_ANALYSIS_DELETE_MODAL', {'delete_key': delete_key});
            },
