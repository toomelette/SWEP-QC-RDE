...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_GRIND_STOPPAGE_CREATE_MODAL', (data) => {
                this.showModal();
            });
        ...
        methods: {
            ...
            store(){ 
                ...
                axios.post('synopsis/grind_stoppage/store', {

                    crop_year_id: this.crop_year_id?.code, 
                    mill_id: this.mill_id?.code,
                    actual_grind_hrs: this.actual_grind_hrs, 
                    actual_grind_tet: this.actual_grind_tet, 
                    total_delays_hrs: this.total_delays_hrs, 
                    total_delays_tet: this.total_delays_tet,
                ...
                .then((response) => {
                    ...
                    if(response.status == 200){
                        ...
                        this.crop_year_id = {};
                        this.mill_id = {};
                        this.actual_grind_hrs = '';
                        this.actual_grind_tet = '';
                        this.total_delays_hrs = '';
                        this.total_delays_tet = '';
