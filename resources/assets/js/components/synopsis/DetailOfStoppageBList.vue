...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            EventBus.$on('DETAIL_OF_STOPPAGE_B_UPDATE_LIST', (data) => {
        ...
        methods: {
            ...
            fetch(page_no){ 
               ...
               axios.get('synopsis/detail_of_stoppage_b', { params: { q: this.search_value, e: this.entry_value, page: page_no, } })
                    .then((response) => {
            ...
            emitCreateModal(){ 
                EventBus.$emit('OPEN_DETAIL_OF_STOPPAGE_B_CREATE_MODAL', {});
            },

            emitUpdateModal(update_key){ 
                EventBus.$emit('OPEN_DETAIL_OF_STOPPAGE_B_UPDATE_MODAL', {'update_key': update_key});
            },

            emitDeleteModal(delete_key){  
                EventBus.$emit('OPEN_DETAIL_OF_STOPPAGE_B_DELETE_MODAL', {'delete_key': delete_key});
            },
