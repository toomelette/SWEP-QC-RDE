...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_NON_SUGAR_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/non_sugar/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/non_sugar/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('NON_SUGAR_UPDATE_LIST', {});
