...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_MIXED_JUICE_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/mixed_juice/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/mixed_juice/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('MIXED_JUICE_UPDATE_LIST', {});
