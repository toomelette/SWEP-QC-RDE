...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            EventBus.$on('MIXED_JUICE_UPDATE_LIST', (data) => {
        ...
        methods: {
            ...
            fetch(page_no){ 
               ...
               axios.get('synopsis/mixed_juice', { params: { q: this.search_value, e: this.entry_value, page: page_no, } })
                    .then((response) => {
            ...
            emitCreateModal(){ 
                EventBus.$emit('OPEN_MIXED_JUICE_CREATE_MODAL', {});
            },

            emitUpdateModal(update_key){ 
                EventBus.$emit('OPEN_MIXED_JUICE_UPDATE_MODAL', {'update_key': update_key});
            },

            emitDeleteModal(delete_key){  
                EventBus.$emit('OPEN_MIXED_JUICE_DELETE_MODAL', {'delete_key': delete_key});
            },
