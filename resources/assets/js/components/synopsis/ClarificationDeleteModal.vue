...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_CLARIFICATION_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/clarification/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/clarification/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('CLARIFICATION_UPDATE_LIST', {});
