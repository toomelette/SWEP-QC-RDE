...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_BH_LOSS_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/bh_loss/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/bh_loss/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('BH_LOSS_UPDATE_LIST', {});
