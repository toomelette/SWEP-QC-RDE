...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_CANE_ANALYSIS_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/cane_analysis/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/cane_analysis/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('CANE_ANALYSIS_UPDATE_LIST', {});
