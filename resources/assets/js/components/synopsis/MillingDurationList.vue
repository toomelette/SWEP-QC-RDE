...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            EventBus.$on('MILLING_DURATION_UPDATE_LIST', (data) => {
        ...
        methods: {
            ...
            fetch(page_no){ 
               ...
               axios.get('synopsis/milling_duration', { params: { q: this.search_value, e: this.entry_value, page: page_no, } })
                    .then((response) => {
            ...
            emitCreateModal(){ 
                EventBus.$emit('OPEN_MILLING_DURATION_CREATE_MODAL', {});
            },

            emitUpdateModal(update_key){ 
                EventBus.$emit('OPEN_MILLING_DURATION_UPDATE_MODAL', {'update_key': update_key});
            },

            emitDeleteModal(delete_key){  
                EventBus.$emit('OPEN_MILLING_DURATION_DELETE_MODAL', {'delete_key': delete_key});
            },
