...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_PRDN_INCREMENT_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/prdn_increment/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/prdn_increment/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('PRDN_INCREMENT_UPDATE_LIST', {});
