...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_MILLING_PLANT_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/milling_plant/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/milling_plant/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('MILLING_PLANT_UPDATE_LIST', {});
