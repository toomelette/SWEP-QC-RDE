...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_MILLING_DURATION_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/milling_duration/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/milling_duration/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('MILLING_DURATION_UPDATE_LIST', {});
