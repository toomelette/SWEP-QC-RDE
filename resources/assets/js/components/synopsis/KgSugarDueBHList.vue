...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            EventBus.$on('KG_SUGAR_DUE_BH_UPDATE_LIST', (data) => {
        ...
        methods: {
            ...
            fetch(page_no){ 
               ...
               axios.get('synopsis/kg_sugar_due_bh', { params: { q: this.search_value, e: this.entry_value, page: page_no, } })
                    .then((response) => {
            ...
            emitCreateModal(){ 
                EventBus.$emit('OPEN_KG_SUGAR_DUE_BH_CREATE_MODAL', {});
            },

            emitUpdateModal(update_key){ 
                EventBus.$emit('OPEN_KG_SUGAR_DUE_BH_UPDATE_MODAL', {'update_key': update_key});
            },

            emitDeleteModal(delete_key){  
                EventBus.$emit('OPEN_KG_SUGAR_DUE_BH_DELETE_MODAL', {'delete_key': delete_key});
            },
