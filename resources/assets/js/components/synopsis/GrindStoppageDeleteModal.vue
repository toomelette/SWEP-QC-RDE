...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_GRIND_STOPPAGE_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/grind_stoppage/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/grind_stoppage/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('GRIND_STOPPAGE_UPDATE_LIST', {});
