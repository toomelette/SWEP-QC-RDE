...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_TEN_YR_FACTORY_PERFORMANCE_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/ten_yr_factory_performance/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/ten_yr_factory_performance/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('TEN_YR_FACTORY_PERFORMANCE_UPDATE_LIST', {});
