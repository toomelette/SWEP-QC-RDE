...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_CAP_UTILIZATION_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/cap_utilization/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/cap_utilization/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('CAP_UTILIZATION_UPDATE_LIST', {});
