...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_DETAIL_OF_STOPPAGE_A_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/detail_of_stoppage_a/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/detail_of_stoppage_a/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('DETAIL_OF_STOPPAGE_A_UPDATE_LIST', {});
