...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_LAST_EXPRESSED_JUICE_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/last_expressed_juice/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/last_expressed_juice/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('LAST_EXPRESSED_JUICE_UPDATE_LIST', {});
