<template>
    <div v-if="collection.length > 0">
        ...
        <h4 style="text-align:center;">CY {{ crop_year }}</h4>
        <br>
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-weight:bold;">{{ totalPerCY(collection, "sgrcane_gross_tonnes") }}</td>
                    <td style="font-weight:bold;">{{ totalPerCY(collection, "sgrcane_net_tonnes") }}</td>
                    <td style="font-weight:bold;">{{ totalPerCY(collection, "rawsgr_tonnes_due_cane") }}</td>
                    <td style="font-weight:bold;">{{ totalPerCY(collection, "rawsgr_tonnes_manufactured") }}</td>
                    <td style="font-weight:bold;">{{ totalPerCY(collection, "equivalent") }}</td>
                </tr>
            </tbody>
        </table>
        </div>
