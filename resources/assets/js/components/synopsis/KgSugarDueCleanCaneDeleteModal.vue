...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_KG_SUGAR_DUE_CLEAN_CANE_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/kg_sugar_due_clean_cane/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/kg_sugar_due_clean_cane/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('KG_SUGAR_DUE_CLEAN_CANE_UPDATE_LIST', {});
