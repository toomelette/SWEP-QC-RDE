...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_MOLASSES_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/molasses/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/molasses/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('MOLASSES_UPDATE_LIST', {});
