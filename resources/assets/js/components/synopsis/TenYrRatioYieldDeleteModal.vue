...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_TEN_YR_RATIO_YIELD_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/ten_yr_ratio_yield/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/ten_yr_ratio_yield/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('TEN_YR_RATIO_YIELD_UPDATE_LIST', {});
