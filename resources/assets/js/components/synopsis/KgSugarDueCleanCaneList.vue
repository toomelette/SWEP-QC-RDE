...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            EventBus.$on('KG_SUGAR_DUE_CLEAN_CANE_UPDATE_LIST', (data) => {
        ...
        methods: {
            ...
            fetch(page_no){ 
               ...
               axios.get('synopsis/kg_sugar_due_clean_cane', { params: { q: this.search_value, e: this.entry_value, page: page_no, } })
                    .then((response) => {
            ...
            emitCreateModal(){ 
                EventBus.$emit('OPEN_KG_SUGAR_DUE_CLEAN_CANE_CREATE_MODAL', {});
            },

            emitUpdateModal(update_key){ 
                EventBus.$emit('OPEN_KG_SUGAR_DUE_CLEAN_CANE_UPDATE_MODAL', {'update_key': update_key});
            },

            emitDeleteModal(delete_key){  
                EventBus.$emit('OPEN_KG_SUGAR_DUE_CLEAN_CANE_DELETE_MODAL', {'delete_key': delete_key});
            },
