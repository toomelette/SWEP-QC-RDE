...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_CLARIFICATION_CREATE_MODAL', (data) => {
                this.showModal();
            });
        ...
        methods: {
            ...
            store(){ 
                ...
                axios.post('synopsis/clarification/store', {

                    crop_year_id: this.crop_year_id?.code, 
                    mill_id: this.mill_id?.code,
                    juice_apparent_purity: this.juice_apparent_purity, 
                    juice_brix: this.juice_brix, 
                    juice_ph: this.juice_ph, 
                    juice_clarity: this.juice_clarity, 
                    lime_tonnes_used: this.lime_tonnes_used, 
                    lime_cao: this.lime_cao, 
                    lime_cao_per_tc: this.lime_cao_per_tc, 
                ...
                .then((response) => {
                    ...
                    if(response.status == 200){
                        ...
                        this.crop_year_id = {};
                        this.mill_id = {};
                        this.juice_apparent_purity = '';
                        this.juice_brix = '';
                        this.juice_ph = '';
                        this.juice_clarity = '';
                        this.lime_tonnes_used = '';
                        this.lime_cao = '';
                        this.lime_cao_per_tc = '';
