...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_BAGASSE_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/bagasse/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/bagasse/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('BAGASSE_UPDATE_LIST', {});
