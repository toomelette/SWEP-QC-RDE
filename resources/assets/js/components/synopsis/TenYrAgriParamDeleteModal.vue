...
<script>
    ...
    export default { 
        ...
        created() {
            ...
            EventBus.$on('OPEN_TEN_YR_AGRI_PARAM_DELETE_MODAL', (data) => {
                this.showModal(data);
            });
        ...
        methods: {
            ...
            showModal(data){ 
                ...
                axios.get('synopsis/ten_yr_agri_param/' + data.delete_key)
                    .then((response) => { 
            ...
            destroy(){ 
                ...
                axios.delete('synopsis/ten_yr_agri_param/' + this.delete_key)
                    .then((response) => {
                        ...
                        if(response.status == 200){
                            ...
                            EventBus.$emit('TEN_YR_AGRI_PARAM_UPDATE_LIST', {});
